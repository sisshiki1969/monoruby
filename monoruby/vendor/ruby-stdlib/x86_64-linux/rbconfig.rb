...
module RbConfig
  RUBY_VERSION.start_with?("4.0.") or
    raise "ruby lib version (4.0.2) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/rbenv/versions/ruby-4.0.2-custom' '--with-ext=openssl,psych,+'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/rbenv/versions/ruby-4.0.2-custom"
  ...
  CONFIG["RUST_LIB"] = "/tmp/ruby-build.20260503012958.10578.waW79t/ruby-4.0.2/target/release/libruby.a"
