...
impl Node {
    ...
    pub(crate) fn new_rational(num: NReal, loc: Loc) -> Self {
        Node::new(NodeKind::Rational(num), loc)
    }

    pub(crate) fn new_rimaginary(num: NReal, loc: Loc) -> Self {
        Node::new(NodeKind::RImaginary(num), loc)
    }
