...
impl Token {
    ...
    pub(crate) fn new_rationallit(num: NReal, loc: Loc) -> Self {
        Annot::new(TokenKind::RationalLit(num), loc)
    }

    pub(crate) fn new_rimaginarylit(num: NReal, loc: Loc) -> Self {
        Annot::new(TokenKind::RImaginaryLit(num), loc)
    }
